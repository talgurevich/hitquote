...
export async function validateSessionAndGetBusinessUserId(session) {
  ...
  if (!businessUserId) {
    ...
    if (existingUserByEmail) {
      ...
      console.log('Updated existing business user with new auth ID:', businessUserId)
    } else {
      // Create new business user record
      ...
      console.log('Created new business user:', businessUserId)
    }
