-- Re-upload products since previous upload didn't persist
...
BEGIN
    ...
    RAISE NOTICE 'Re-uploading bread station catalog to both accounts...';
    ...
    RAISE NOTICE 'Successfully re-uploaded 39 bread station products to both accounts';
